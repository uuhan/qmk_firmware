...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FNKEYS] = LAYOUT(
        ...
        KC_TAB , KC_F7, KC_TRNS, KC_HOME, KC_PGUP, KC_PGDN, KC_END , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_BSPC,
        KC_LCTL, KC_F8, KC_TRNS, KC_BSPC, KC_DEL , KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_MUTE, KC_COLN, KC_DQUO, KC_ENT,
