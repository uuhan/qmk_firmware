...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT( //  default layer
        ...
        CTL_T(KC_ESC), LT(MOUSE_L, KC_A), LT(FNKEYS, KC_S), KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, LT(FNKEYS, KC_L), TD(SCLN), TD(QUOTE), MT(MOD_RCTL, KC_ENT),
        OSM(MOD_LSFT), GUI_T(KC_Z), CTL_T(KC_X), ALT_T(KC_C), KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, RGUI_T(KC_SLSH), MT(MOD_RSFT, KC_ESC), MO(HHKB),
    ...
    [HHKB] = LAYOUT(
        ...
        RESET  , DYN_REC_START1, DYN_REC_STOP, DYN_MACRO_PLAY1, KC_TRNS, KC_TRNS, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, KC_RSFT, KC_TRNS,
    ...
    [FNKEYS] = LAYOUT(
        ...
        KC_LCTL, KC_F8, KC_TRNS, KC_BSPC, KC_DEL , KC_PIPE, KC_BSLS, KC_MINS, KC_EQL , KC_TRNS, KC_GRV , KC_DQUO, KC_ENT,
