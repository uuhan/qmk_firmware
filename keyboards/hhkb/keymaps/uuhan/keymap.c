...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT( //  default layer
        ...
        GUI_T(KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, LGUI_T(KC_BSPC),
    ...
    [MIRROR] = LAYOUT(
        KC_TRNS, KC_BSLS, KC_EQL, KC_MINS, KC_0, KC_9, KC_8, KC_7, KC_6, KC_5, KC_4, KC_3, KC_2, KC_1, KC_ESC,
        KC_TRNS, KC_P, KC_O, KC_I, KC_U, KC_Y, KC_T, KC_R, KC_E, KC_W, KC_Q, KC_LBRC, KC_RBRC, KC_TAB,
        KC_TRNS, KC_SCLN, KC_L, KC_K, KC_J, KC_H, KC_G, KC_F, KC_D, KC_S, KC_A, KC_TRNS, CTL_T(KC_ESC),
    ...
    [SPACEFN] = LAYOUT(
        ...
        KC_TRNS        , KC_RPRN, KC_LCBR, KC_RCBR, KC_RPRN , KC_DEL , KC_GRV , KC_P0  , KC_LT  , KC_GT   , KC_QUES, KC_PDOT, KC_TRNS,
    ...
    [FNKEYS] = LAYOUT(
        ...
        KC_TRNS, KC_F7, KC_TRNS, KC_HOME, KC_PGUP, KC_PGDN, KC_END , KC_UNDS, KC_PLUS, KC_PIPE, KC_TILD, KC_LCBR, KC_RCBR, KC_BSPC,
        KC_TRNS, KC_F8, KC_TRNS, KC_BSPC, KC_DEL , KC_PIPE, KC_BSLS, KC_MINS, KC_EQL , KC_BSLS, KC_GRV , KC_DQUO, KC_ENT,
        KC_TRNS, KC_F9, KC_F10, KC_F11  , KC_F12 , KC_F13 , KC_F14 , KC_F15 , KC_LT  , KC_GT  , KC_QUES, KC_RSFT, KC_TRNS,
